...
/**
 * This class is used to control the two light sensors placed in front of each of the 
 * robot's wheels. The main functionality is the line localization which will move the robot's wheels
 * until they both see a line under their respective light sensor. 
 * 
...
public class LightSensorController {
	...
	/**
	 * The function moves until the robot detected line on both side of the wheel.
	 */
